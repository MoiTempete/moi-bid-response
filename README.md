...
> 由 [歸藏](https://x.com/op7418) 基于煤矿安全、信息化平台等多个真实项目的中标响应文件沉淀而成。
...
```text
帮我安装 moi-bid-response skill。请把 https://github.com/op7418/moi-bid-response-skill 克隆到 ~/.claude/skills/moi-bid-response，安装完成后检查 SKILL.md、references/、scripts/ 是否存在。
```
...
> 2. 执行 `git clone https://github.com/op7418/moi-bid-response-skill.git ~/.claude/skills/moi-bid-response`
